...
export const ServerHeader = ({
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 dark:bg-[#101620] bg-[#F2F3F5] z-50 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px] ">
                ...
                {isModerator && (<DropdownMenuItem onClick={() => onOpen("createChannel")} className=" px-3 py-2 text-sm cursor-pointer">
